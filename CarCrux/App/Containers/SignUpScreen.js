                ...
                <ScrollView style={styles.container}>
                    ...
                    <Container style={styles.container} >
                        <Content>
                            ...
                            <Text style={styles.signUp}>Create your CarCrux account.</Text>
                            <Text style={styles.validation}>Password must be at least 8 characters, two uppercase letter, two numbers, one special character</Text>
                            <Text style={styles.validation}>Username must be 3-15 characters, no special characters</Text>
